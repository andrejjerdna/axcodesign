...
10. Если во время построения плагина появилось сообщение вида "Некорректная геометрия пластины 1." (см. рис. 1.13), это означает, что необходимо обратить внимание по получившуюся геометрию главной
...
4. Меню выбора "Задать настройки пластин 2, 3 и 4" позволяет назначать толщину, класс и материал пластин связей, в зависимости от порядкового номера связи.
